...
if (!isset($_COOKIE['lan']) or $_COOKIE['lan']=="ua") {
  $result=mysql_query("SELECT title,text_main FROM ua WHERE page='about_us'",$db);
...
if (isset($_COOKIE['lan']) and $_COOKIE['lan']=="en") {
  $result=mysql_query("SELECT title,text_main FROM en WHERE page='about_us'",$db);
  $myrow=mysql_fetch_array($result);
...
if (isset($_COOKIE['lan']) and $_COOKIE['lan']=="ru") {
  $result=mysql_query("SELECT title,text_main FROM ru WHERE page='about_us'",$db);
  $myrow=mysql_fetch_array($result);
